    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marks', models.ManyToManyField(related_name='marks', to=settings.AUTH_USER_MODEL)),
                ('subtopic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='subtopics.subtopic')),
            ],
            options={
                'abstract': False,
            },
